                  ...
                  <?php
                  if(isset($_POST['dprAdd']))
                  {
                    $spr_Id= $_POST["sprId"];
                    $spr_details = $_POST["sprDetails"];
                    
                    
                    require_once "db.php";
                    $sql = "INSERT INTO `depreciation`(`supplier_id`, `supplier_dts`) VALUES ('$spr_Id','$spr_details')";
...
<body>
    <nav class="navbar navbar-expand-sm navbar-primary" id="neubar">
        <div class="container">
          ...
          <li class="nav-item dropdown">
          <a class="nav-link mx-2 dropdown-toggle"  id="navbarDropdownMenuLink" role="button" data-bs-toggle="dropdown" aria-expanded="false" >Asset Categories</a>
            <ul class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
            ...
            <div class="col-12 col-md-9 col-lg-7 col-xl-6">
              <div class="card" style="border-radius: 15px;">
                <div class="card-body p-5">
                  <h2 class="text-uppercase text-center mb-5">Supplier Details</h2>
                  ...
                  <form method="post" action="">
                    ...
                    <div class="form-outline mb-4">
                      <label class="form-label" for="form3Example3cg">Supplier Id</label>
                      <input type="text" id="form3Example3cg" class="form-control form-control-lg" name="sprId" required="required" />
                      
                    </div>
    
                    <div class="form-outline mb-4">
                      <label class="form-label" for="form3Example4cg">Supplier Details</label>
                      <input type="text" id="form3Example4cg" class="form-control form-control-lg" name="sprDetails" required="required"/>
                      
                    </div>
     
    
                    <div class="d-flex justify-content-center">
                      <button type="submit" name="dprAdd"
