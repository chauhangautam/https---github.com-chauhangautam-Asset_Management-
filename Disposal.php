                  ...
                  if(isset($_POST['Add_Disposal']))
                  {
                    ...
                    $dspDate = $_POST["dspDate"];
                    $dspCost = $_POST["dspCost"];
                     
                    require_once "db.php";
                    $sql = "INSERT INTO `disposal`(`dspl_id`, `asset_id`, `dspl_date`, `dspl_cost`) VALUES ('$dspId','$assetId','$dspDate','$dspCost')";
            ...
            <div class="col-12 col-md-9 col-lg-7 col-xl-6">
              <div class="card" style="border-radius: 15px;">
                <div class="card-body p-5">
                  <h2 class="text-uppercase text-center mb-5">Asset Disposal</h2>
                  ...
                  <form method="post" action="">
                    ...
                    <div class="form-outline mb-4">
                      <label class="form-label" for="form3Example3cg">Disposal Id</label>
                      <input type="text" id="form3Example3cg" class="form-control form-control-lg"  name="dspId" required="required"/>
                      
                    </div>
    
                    <div class="form-outline mb-4">
                      <label class="form-label" for="form3Example4cg">Asset Id</label>
                      <input type="text" id="form3Example4cg" class="form-control form-control-lg"  name="assetId" required="required" />
                      
                    </div>
    
                    <div class="form-outline mb-4">
                      <label class="form-label" for="form3Example4cg">Disposal  Date</label>
                      <input type="date" id="form3Example4cg" class="form-control form-control-lg"  name="dspDate" required="required"/>
                      
                    </div>
    
                    
                    <div class="form-outline mb-4">
                      <label class="form-label" for="form3Example4cg">Disposal  Amount (INR)</label>
                      <input type="text" id="form3Example4cg" class="form-control form-control-lg"  name="dspCost" required="required" />
                      
                    </div>
    
                    <div class="d-flex justify-content-center">
                      <button type="submit" name="Add_Disposal"
