<?php
                    include_once 'db.php';
                    $result = mysqli_query($conn,"SELECT * FROM disposal");
                    ?>
...
<style>
 ...
 <body>
        ...
        <ul class="navbar-nav ms-auto ">
          ...
          <a class="nav-link mx-2 dropdown-toggle"  id="navbarDropdownMenuLink" role="button" data-bs-toggle="dropdown" aria-expanded="false" >Asset Categories</a>
            <ul class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
              <li><a class="dropdown-item" href="AddCateg.php">Add Category</a></li>
  ...
  <?php
                    ...
                    ?>
                    <tr>
                        <td><?php echo $row["dspl_id"]; ?></td>
                        <td><?php echo $row["asset_id"]; ?></td>
                        <td><?php echo $row["dspl_date"]; ?></td>
                        <td><?php echo $row["dspl_cost"]; ?></td>
